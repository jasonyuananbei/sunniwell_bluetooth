...
/*Sync3ddService.java shoud be in ../rtk3dd/ */
import com.android.bluetooth.rtk3dd.Sync3ddService;
...
public class Config {
    ...
    private static final Class[] PROFILE_SERVICES = {
        ...
        Sync3ddService.class/*BOARD_HAVE_BLUETOOTH_RTK_3DD*/
    };
    /**
    ...
    private static final int[]  PROFILE_SERVICES_FLAG = {
        ...
        R.bool.profile_supported_3dd/*BOARD_HAVE_BLUETOOTH_RTK_3DD*/
    };
