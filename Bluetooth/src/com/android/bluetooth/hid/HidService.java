...
/*BOARD_HAVE_BLUETOOTH_RTK_VR Begin*/
    private static final int MESSAGE_RTKBT_VR_START_SERVICE = 13;
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                break;
/*BOARD_HAVE_BLUETOOTH_RTK_VR Begin*/
                case MESSAGE_RTKBT_VR_START_SERVICE:
                {
                    //start voice service
                    int status = msg.arg1;
                    log("cheng_@start iflytek NOW!");
                    startService(new Intent("com.iflytek.vocmd.START"));
                }
                break;
/*BOARD_HAVE_BLUETOOTH_RTK_VR end*/
            }
...
/*BOARD_HAVE_BLUETOOTH_RTK_VR Begin*/
if(getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_RTK_VR))
{
        //BTHH_CONN_STATE_RTKBT_VR_CONNECTED
        if (state == CONN_STATE_RTKBT_VR_CONNECTED){
            log("cheng_@HidService.java onConnectStateChanged");
            Message msg = mHandler.obtainMessage(MESSAGE_RTKBT_VR_START_SERVICE);
            msg.obj = address;
            msg.arg1 = state;
            mHandler.sendMessage(msg);
            return;
...
/*BOARD_HAVE_BLUETOOTH_RTK_VR end*/
    ...
    private final static int CONN_STATE_RTKBT_VR_CONNECTED = 0xF0;  /*BOARD_HAVE_BLUETOOTH_RTK_VR*/
