...
/*BOARD_HAVE_BLUETOOTH_RTK_3DD Begin*/
#ifdef BLUETOOTH_RTK_3DD
static void rtkbt_3dd_send_message(short evt, UINT8 evt_opcode, UINT8 *p, UINT8 evt_len) ;
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_3DD End*/
...
/*BOARD_HAVE_BLUETOOTH_RTK_3DD Begin*/
                ...
                case 0x23:
                case 0x28:
                    BT_TRACE_0(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "3dd assoacition event");
                    BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "rtkbt_subevent_code = %x",rtkbt_subevent_code);
                    int i;
                    for(i =0; i<hci_evt_len; i++)
                        BT_TRACE_1(TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "data = %x", *(p+i));
                    rtkbt_3dd_send_message(BT_EVT_RTKBT_3DD_EVT, hci_evt_code, p, hci_evt_len);
                    break;
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_3DD End*/
#ifdef BLUETOOTH_RTK_AUTOPAIR
...
/*BOARD_HAVE_BLUETOOTH_RTK_3DD Begin*/
#ifdef BLUETOOTH_RTK_3DD
            case HCI_RTKBT_3DD_FRAME_SYNC_CAPTURE_EVT: //0x4E
                BT_TRACE_0 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "HCI_FRAME_SYNC_CAPTURE_EVT");
                BT_TRACE_1 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "evt_len = %d", hci_evt_len);
                rtkbt_3dd_send_message(BT_EVT_RTKBT_3DD_EVT, hci_evt_code, p, hci_evt_len);
                break;
            case HCI_RTKBT_3DD_SYNC_TRAIN_COMPLETE_EVT: //0x4F
                BT_TRACE_0 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "HCI_SYNC_TRAIN_COMPLETE_EVT");
                BT_TRACE_1 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "evt_len = %d", hci_evt_len);
                rtkbt_3dd_send_message(BT_EVT_RTKBT_3DD_EVT, hci_evt_code, p, hci_evt_len);
                break;
            case HCI_RTKBT_3DD_CONNECTIONLESS_SLAVE_BROADCAST_TIMEOUT_EVT: //0x52
                BT_TRACE_0 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "HCI_CONNECTIONLESS_SLAVE_BROADCAST_TIMEOUT_EVT");
                BT_TRACE_1 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "evt_len = %d", hci_evt_len);
                rtkbt_3dd_send_message(BT_EVT_RTKBT_3DD_EVT, hci_evt_code, p, hci_evt_len);
                break;
            case HCI_RTKBT_3DD_SLAVE_PAGE_RESPONSE_TIMEOUT_EVT:// 0x54
                BT_TRACE_0 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "HCI_SLAVE_PAGE_RESPONSE_TIMEOUT_EVT");
                BT_TRACE_1 (TRACE_LAYER_HCI, TRACE_TYPE_EVENT, "evt_len = %d", hci_evt_len);
                rtkbt_3dd_send_message(BT_EVT_RTKBT_3DD_EVT, hci_evt_code, p, hci_evt_len);
                break;
#endif
...
static void btu_hcif_num_compl_data_pkts_evt (UINT8 *p, UINT16 evt_len)
{
    BT_TRACE_0 (TRACE_LAYER_HCI, TRACE_TYPE_ERROR, "btu_hcif_num_compl_data_pkts_evt");
