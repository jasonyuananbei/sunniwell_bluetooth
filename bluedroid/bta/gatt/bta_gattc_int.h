...
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT Begin*/
#ifdef BLUETOOTH_RTK_VR
typedef struct
{
    BT_HDR                  hdr;
    UINT16                  configureMTU_value;
}tBTA_GATTC_API_CONFIGURE_MTU;
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT end*/
...
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT Begin*/
#ifdef BLUETOOTH_RTK_VR
    tBTA_GATTC_API_CONFIGURE_MTU api_configure_mtu;
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT end*/
} tBTA_GATTC_DATA;
...
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT begin*/
#ifdef BLUETOOTH_RTK_VR
extern void bta_gattc_RTKBT_VR_configure_mtu(tBTA_GATTC_CLCB *p_clcb, tBTA_GATTC_DATA *p_data);
extern void bta_gattc_RTKBT_VR_configureMTU_cmpl(tBTA_GATTC_CLCB *p_clcb, tBTA_GATTC_OP_CMPL *p_data);
#endif
/*BOARD_HAVE_BLUETOOTH_RTK_VR_RCU_MDT end*/
